...
import type { AboutSlides } from "../utils/types/about_slides";

export default function ValueSlider() {
  const [slides, setSlides] = useState<AboutSlides[]>([]);
  ...
  const icons = [<FaFire />, <FaTrophy />, <FaTrophy />, <FaFire />];
  ...
  return (
    <section
      ...
      className="bg-[#EFECE1] py-[40px] overflow-hidden relative cursor-none select-none"
    >
      <motion.div
